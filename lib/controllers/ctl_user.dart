    ...
    try {
      ...
      if (user.isNotEmpty) {
        ...
        if (data.isNotEmpty) {
          ...
          // if (int.parse(data['HinhThuc'].toString()) == 2) {
          //   await db.updateCell(
          //       tbName: 'T00_User', field: 'VinhVien', value: 1);
          //   await dbw.updateData(
          //       tbName: 'KHACH_SD',
          //       field: 'NgayLamViec',
          ...
          // } else {
          //   await db.updateCell(
          //       tbName: 'T00_User', field: 'VinhVien', value: 0);
          await dbw
              .updateData(
                  tbName: 'KHACH_SD',
                  field: 'NgayLamViec',
          ...
          //Nếu không tìm thấy trên web thì kích hoạt lại
          // print(data);
          // if(data['err']!=null){
          //   EasyLoading.showInfo(data['error'].toString());
          //
          //   return;
          // }
          EasyLoading.dismiss();
          WgtDialog(
              title: 'Thông báo',
              text: 'Ứng dụng chưa được kích hoạt!',
              onConfirm: () async {
                await db.updateCell(
                    tbName: 'T00_User',
                    field: 'MaKichHoat',
