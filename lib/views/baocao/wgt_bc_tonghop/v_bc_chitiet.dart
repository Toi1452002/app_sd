            ...
            itemBuilder: (context, i) {
              return Column(
                children: [
                  ...
                  //   child: Row(
                  //     children: [
                  //       Expanded(flex: 1,child: cell_Header(text: '',border: true)),
                  //       Expanded(flex: 2,child: cell_Header(text: 'Số Trúng',border: true)),
                  //       Expanded(flex: 2,child: cell_Header(text: 'Điểm trúng',border: true)),
                  //       Expanded(flex: 2,child: cell_Header(text: 'Tiền Trúng',border: true)),
                  //     ],
                  //   ),
                  // ),
                  // SizedBox(
                  ...
                  //   child: Row(
                  //     children: [
                  //       Expanded(flex: 1,child: cell_Body(text: '2s',)),
                  //       Expanded(flex: 2,child: PopupMenuButton(
                  //           itemBuilder: (context)=>[
                  //             PopupMenuItem(textStyle: const TextStyle(color: Colors.black),child: Text( data[i]['SoTrung2s']))
                  //           ],
                  //           child: cell_Body(text: data[i]['SoTrung2s'],alignment: Alignment.centerLeft,pdLeft: 3))),
                  //       Expanded(flex: 2,child: cell_Body(text: data[i]['DiemTrung2s'],alignment: Alignment.centerRight,pdRight: 3)),
                  //       Expanded(flex: 2,child: cell_Body(text: data[i]['TienTrung2s'],alignment: Alignment.centerRight,pdRight: 3)),
                  //     ],
                  //   ),
                  // ),
                  // SizedBox(
                  ...
                  //   child: Row(
                  //     children: [
                  //       Expanded(flex: 1,child: cell_Body(text: '3s',)),
                  //       Expanded(flex: 2,child: PopupMenuButton(
                  //           itemBuilder: (context)=>[
                  //             PopupMenuItem(textStyle: const TextStyle(color: Colors.black),child: Text( data[i]['SoTrung3s']))
                  //           ],
                  //           child: cell_Body(text: data[i]['SoTrung3s'],alignment: Alignment.centerLeft,pdLeft: 3))),
                  //       Expanded(flex: 2,child: cell_Body(text: data[i]['DiemTrung3s'],alignment: Alignment.centerRight,pdRight: 3)),
                  //       Expanded(flex: 2,child: cell_Body(text: data[i]['TienTrung3s'],alignment: Alignment.centerRight,pdRight: 3)),
                  //     ],
                  //   ),
                  // ),
                  // SizedBox(
                  ...
                  //   child: Row(
                  //     children: [
                  //       Expanded(flex: 1,child: cell_Body(text: '4s',)),
                  //       Expanded(flex: 2,child: PopupMenuButton(
                  //         itemBuilder: (context)=>[
                  //           PopupMenuItem(textStyle: const TextStyle(color: Colors.black),child: Text( data[i]['SoTrung4s']))
                  //         ],
                  //         child: cell_Body(text: data[i]['SoTrung4s'],alignment: Alignment.centerLeft,pdLeft: 3),
                  //       )),
                  //       Expanded(flex: 2,child: cell_Body(text: data[i]['DiemTrung4s'],alignment: Alignment.centerRight,pdRight: 3)),
                  //       Expanded(flex: 2,child: cell_Body(text: data[i]['TienTrung4s'],alignment: Alignment.centerRight,pdRight: 3)),
                  //     ],
                  //   ),
                  // ),
                  // SizedBox(
                  ...
                  //   child: Row(
                  //     children: [
                  //       Expanded(flex: 1,child: cell_Body(text: 'Dt',)),
                  //       Expanded(flex: 2,child: PopupMenuButton(
                  //
                  //         itemBuilder: (BuildContext context)=>[
                  //           PopupMenuItem(textStyle: const TextStyle(color: Colors.black),child: Text(data[i]['SoTrungDt']),)
                  //         ],
                  //         child: cell_Body(text: data[i]['SoTrungDt'],alignment: Alignment.centerLeft,pdLeft: 3),
                  //       )),
                  //       Expanded(flex: 2,child: cell_Body(text: data[i]['DiemTrungDt'],alignment: Alignment.centerRight,pdRight: 3)),
                  //       Expanded(flex: 2,child: cell_Body(text: data[i]['TienTrungDt'],alignment: Alignment.centerRight,pdRight: 3)),
                  //     ],
                  //   ),
                  // ),
                  // SizedBox(
                  ...
                  //   child: Row(
                  //     children: [
                  //       Expanded(flex: 1,child: cell_Body(text: 'Dx',)),
                  //       Expanded(flex: 2,child: PopupMenuButton(
                  //         itemBuilder: (BuildContext context) {
                  //           return [
                  //             PopupMenuItem(textStyle: const TextStyle(color: Colors.black), child: Text(data[i]['SoTrungDx']))
                  //           ];
                  //         },
                  //         child: cell_Body(text: data[i]['SoTrungDx'],alignment: Alignment.centerLeft,pdLeft: 3),
                  //       )),
                  //       Expanded(flex: 2,child: cell_Body(text: data[i]['DiemTrungDx'],alignment: Alignment.centerRight,pdRight: 3)),
                  //       Expanded(flex: 2,child: cell_Body(text: data[i]['TienTrungDx'],alignment: Alignment.centerRight,pdRight: 3)),
                  //     ],
                  //   ),
                  // ),
                ],
